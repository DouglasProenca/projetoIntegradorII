        ...
        if (String.valueOf(txtSenha.getPassword()).equals("1234")) {
            try {
                ...
                PreparedStatement instrucaoSQL = conexao.prepareStatement(
                        "BACKUP DATABASE [ibcp] TO  DISK = N'C:\\Users\\Douglas\\Desktop\\ibcp.bak' WITH NOFORMAT, NOINIT,  NAME = N'sistema-Completo Banco de Dados Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10");
                instrucaoSQL.executeUpdate();
                progbarProgresso.setMaximum(2);
                progbarProgresso.setValue(100);
                JOptionPane.showMessageDialog(this, "Backup realizado na pasta: "
                        + "C:\\Users\\Douglas\\Desktop\\ibcp.bak");
